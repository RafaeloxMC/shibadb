import { Gamepad2, Users, Key, Activity, Database } from "lucide-react";
...
export default async function Home({ user, saves }: HomeProps) {
				...
				<div className="max-w-7xl mx-auto px-6 py-8">
					...
					<div className="flex flex-col gap-4">
						...
						<div className="bg-white/60 dark:bg-neutral-800/60 backdrop-blur-sm rounded-2xl shadow-lg border border-neutral-200/50 dark:border-neutral-700/50 p-6">
							...
							{saves?.length === 0 ? (
								<div className="text-center py-12">
									<Database className="w-16 h-16 text-neutral-400 dark:text-neutral-600 mx-auto mb-4" />
									<h3 className="text-lg font-medium text-neutral-900 dark:text-white mb-2">
										No saves yet
									</h3>
									<p className="text-neutral-600 dark:text-neutral-400 mb-4">
										Start playing a game to save progress!
									</p>
								</div>
							) : (
								<div className="space-y-3">
